...
The accuracy of the decision tree on the testing data is 79%. This means that the decision tree correctly predicted the Baselinehistological.staging for 79% of the patients in the testing data
