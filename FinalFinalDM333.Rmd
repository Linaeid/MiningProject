...
install.packages('rpart.plot')# Install the Hmisc package        
}
...
```{r}
# Choose a CRAN mirror (you can replace 'https://cloud.r-project.org' with a mirror URL of your choice)
options(repos = c(CRAN = 'https://cloud.r-project.org'))

# Now try installing the 'ggtext' package again
